...
class CommentaireController extends Controller
{
     ...
     *
     * @Route("/new/{idUtilisateur}/{idVoyage}", name="commentaire_new")
     * @Method("POST")
     */
    public function newAction( $idUtilisateur, $idVoyage, Request $request)
    {
        $commentaire = new Commentaire();
        $commentaire->setMessage($request->request->get('_message'));
